...
var labels = map[string]*Label{
	...
	"导航-社交":   {ix.Position{X: 732, Y: 467}, ix.Color{}, 3 * time.Second},
	...
	"奈特的金字塔-副本结算-离开":   {ix.Position{X: 250, Y: 420}, ix.ColorButtonBlue, 5 * time.Second},
	...
	"金钩海兵王-副本结算-离开":   {ix.Position{X: 250, Y: 420}, ix.ColorButtonBlue, 5 * time.Second},
