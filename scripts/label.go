...
var labels = map[string]*Label{
	...
	"日常-进度-倒数3号":           {ix.Position{X: 774, Y: 400}, ix.Color{R: 255, G: 123, B: 80}, time.Second},
	"日常-进度-倒数2号":           {ix.Position{X: 774, Y: 436}, ix.Color{R: 255, G: 123, B: 80}, time.Second},
	"日常-进度-倒数1号":           {ix.Position{X: 774, Y: 472}, ix.Color{R: 255, G: 123, B: 80}, time.Second},
