...
var labels = map[string]*Label{
	...
	// "日常-进度-材料副本":   {ix.Position{X: 715, Y: 215}, ix.ColorButtonGray, time.Second},
	// "日常-进度-精英副本":   {ix.Position{X: 715, Y: 253}, ix.ColorButtonGray, time.Second},
	// "日常-进度-奈特的金字塔": {ix.Position{X: 715, Y: 291}, ix.ColorButtonGray, time.Second},
	// "日常-进度-周常副本":   {ix.Position{X: 715, Y: 367}, ix.ColorButtonGray, time.Second},
	// "日常-进度-进化系统":   {ix.Position{X: 715, Y: 408}, ix.ColorButtonGray, time.Second},
	// "日常-进度-金钩海兵王": {ix.Position{X: 715, Y: 316}, ix.ColorButtonGray, time.Second},
	// "日常-进度-天空岛贸易": {ix.Position{X: 715, Y: 355}, ix.ColorButtonGray, time.Second},
	// "日常-进度-怪物乐园": {ix.Position{X: 715, Y: 471}, ix.ColorButtonGray, time.Second},
