...
func init() {
	record.ProvideTask("天空岛贸易", tkdmy)
	record.ProvideTask("材料副本", clfb)
	record.ProvideTask("精英副本", jyfb)
	record.ProvideTask("周常副本", zcfb)
	record.ProvideTask("特殊周常副本", zcfb)
	record.ProvideTask("奈特的金字塔", ntdjzt)
	record.ProvideTask("武陵道场", wldc)
	record.ProvideTask("金钩海兵王", jghbw)
	record.ProvideTask("怪物乐园", gwly)
	record.ProvideTask("自动战斗时间", zdzdsj)
	record.ProvideTask("公会签到", ghqd)
	record.ProvideTask("领取个人奖励", lqgrjl)
	record.ProvideTask("送人气", srq)
	record.ProvideTask("领取日常奖励", lqrcjl)
	record.ProvideTask("公会聊天", ghlt)
	record.ProvideTask("领取公会奖励", lqghjl)
	record.ProvideTask("怪物乐园跳关", gwlytg)
	record.ProvideTask("委托佣兵", wtyb)
}

// tkdmy 天空岛贸易
func tkdmy(ctx context.Context, c *record.Context) {
...
// wldc 武陵道场
func wldc(ctx context.Context, c *record.Context) {
	LabelWait(ctx, "世界-电量", 5*time.Second)
...
// zcfb 周常副本
func zcfb(ctx context.Context, c *record.Context) {
	LabelWait(ctx, "世界-电量", 5*time.Second)
	LabelWaitClick(ctx, "世界-日常", 5*time.Second)
	LabelWait(ctx, "日常-进度", 5*time.Second)
	LabelClick(ctx, "日常-简化模式3号")
	if mode := c.GetOption("模式"); mode == "特殊" {
...
// jyfb 精英副本
func jyfb(ctx context.Context, c *record.Context) {
	LabelWait(ctx, "世界-电量", 5*time.Second)
	LabelWaitClick(ctx, "世界-日常", 5*time.Second)
	LabelWait(ctx, "日常-进度", 5*time.Second)
	LabelClick(ctx, "日常-简化模式2号")
	LabelWait(ctx, "精英副本-普通", 5*time.Second)
	if mode := c.GetOption("模式"); mode == "单人" {
...
// ntdjzt 奈特的金字塔
func ntdjzt(ctx context.Context, c *record.Context) {
	LabelWait(ctx, "世界-电量", 5*time.Second)
	LabelWaitClick(ctx, "世界-日常", 5*time.Second)
	LabelWait(ctx, "日常-进度", 5*time.Second)
...
// jghbw 金钩海兵王
func jghbw(ctx context.Context, c *record.Context) {
	LabelWait(ctx, "世界-电量", 5*time.Second)
	LabelWaitClick(ctx, "世界-日常", 5*time.Second)
	LabelWait(ctx, "日常-进度", 5*time.Second)
...
// gwly 怪物乐园
func gwly(ctx context.Context, c *record.Context) {
	LabelWait(ctx, "世界-电量", 5*time.Second)
	LabelWaitClick(ctx, "世界-日常", 5*time.Second)
	LabelWait(ctx, "日常-进度", 5*time.Second)
	LabelClick(ctx, "日常-简化模式7号")
	buff := c.GetOption("经验增益")
...
// zdzdsj 自动战斗时间
func zdzdsj(ctx context.Context, c *record.Context) {
...
// ghqd 公会签到
func ghqd(ctx context.Context, c *record.Context) {
	LabelWait(ctx, "世界-电量", 5*time.Second)
	LabelWaitClick(ctx, "世界-公会", 5*time.Second)
	LabelWait(ctx, "公会-领地树", 5*time.Second)

	if flag := c.GetOption("领地树祝福"); flag != "NO" {
...
// lqgrjl 领取个人奖励
func lqgrjl(ctx context.Context, c *record.Context) {
	LabelWait(ctx, "世界-电量", 5*time.Second)
...
// srq 送人气
func srq(ctx context.Context, c *record.Context) {
	LabelWait(ctx, "世界-电量", 5*time.Second)
...
// lqrcjl 领取日常奖励
func lqrcjl(ctx context.Context, c *record.Context) {
	LabelWait(ctx, "世界-电量", 5*time.Second)
...
// ghlt 公会聊天
func ghlt(ctx context.Context, c *record.Context) {
...
// lqghjl 领取公会奖励
func lqghjl(ctx context.Context, c *record.Context) {
	LabelWait(ctx, "世界-电量", 5*time.Second)
	LabelWaitClick(ctx, "世界-公会", 5*time.Second)
...
// gwlytg 怪物乐园跳关
func gwlytg(ctx context.Context, c *record.Context) {
	LabelWait(ctx, "世界-电量", 5*time.Second)
	LabelWaitClick(ctx, "世界-日常", 5*time.Second)
	...
	time.Sleep(time.Second)
	LabelWaitClick(ctx, "日常-进度-怪物乐园跳关", 5*time.Second)
...
// 委托佣兵
func wtyb(ctx context.Context, c *record.Context) {
	LabelWait(ctx, "世界-电量", 5*time.Second)
	LabelWaitClick(ctx, "世界-委托", 5*time.Second)
	LabelWait(ctx, "委托-切换", 5*time.Second)
	maxChange, _ := strconv.ParseInt(c.GetOption("最大切换"), 10, 64)
	maxChange = min(max(maxChange, 0), 5)
	maxAccept, _ := strconv.ParseInt(c.GetOption("最大接受"), 10, 64)
